...
# Training
~/anaconda3/envs/tensorflow_p36/bin/mpirun -np $gpus -hostfile /home/ubuntu/cloud/gpt-2/hosts -mca plm_rsh_no_tree_spawn 1 \
	-bind-to socket -map-by slot \
	-x HOROVOD_HIERARCHICAL_ALLREDUCE=1 -x HOROVOD_FUSION_THRESHOLD=16777216 \
	-x NCCL_MIN_NRINGS=4 -x LD_LIBRARY_PATH -x PATH -mca pml ob1 -mca btl ^openib \
	-x NCCL_SOCKET_IFNAME=$INTERFACE -mca btl_tcp_if_exclude lo,docker0 \
	-x TF_CPP_MIN_LOG_LEVEL=0 \
	python -W ignore /home/ubuntu/cloud/gpt-2/train-horovod.py --dataset /home/ubuntu/cloud/gpt-2/juvenile.npz --restore_from fresh --run_name juvenile_node-2_np-1 --sample_every 10_000 --save_every 10_000
